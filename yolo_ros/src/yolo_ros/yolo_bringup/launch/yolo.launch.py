...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        model_cmd = DeclareLaunchArgument(
            "model", default_value="/home/iras/yolo_ros/best.pt", description="Model name or path"
        )
        ...
        depth_info_reliability_cmd = DeclareLaunchArgument(
            ...
            default_value="1",
            choices=["0", "1", "2"],
            description="Specific reliability QoS of the input depth info topic (0=system default, 1=Reliable, 2=Best Emodelffort)",
        )
