...
class Detect3DNode(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        # parameters
        self.declare_parameter("target_frame", "camera_link") #I WAS THINKING TO CHANGE "base_link" WITH "camera_link" IDK THE DIFFERENCE (TAHA MOMAYIZ)
        self.declare_parameter("maximum_detection_threshold", 0.05) # 0.05 is working (TAHA MOMAYIZ)
